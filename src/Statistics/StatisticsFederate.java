...
//        log( "Deleted Object, handle=" + objectHandle );
    ...
    private void publishAndSubscribe() throws RTIexception
    {
        ...
        AttributeHandleSet statisticsAttributes = rtiamb.getAttributeHandleSetFactory().create();
        statisticsAttributes.add(avgPayingDurationHandle);
        statisticsAttributes.add(avgBeingInShopDurationHandle);
        statisticsAttributes.add(avgBeingInQueueDurationHandle);
        statisticsAttributes.add(avgBeingInCheckoutDurationHandle);
        statisticsAttributes.add(avgNumberOfProductsInBasketHandle);
